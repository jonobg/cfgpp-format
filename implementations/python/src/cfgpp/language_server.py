...
class DiagnosticsEngine:
    ...
    def _validate_schema(self, uri: str, parsed_doc: Dict) -> List[Diagnostic]:
        ...
        try:
            ...
            _, validation_result = load_with_auto_schema(
                str(file_path), validate=True
            )
                ...
                for msg in validation_result.messages:
                    ...
                    diagnostic = Diagnostic(
                        range=Range(
                            ...
                            end=Position(line=msg.line or 0, character=(msg.col or 0) + 10)
                        ),
                        severity=severity,
...
class CompletionProvider:
    ...
    def _complete_keywords(self) -> List[CompletionItem]:
        ...
        return [
            CompletionItem(label="enum", kind=14, detail="Define enumeration", insert_text="enum::"),
