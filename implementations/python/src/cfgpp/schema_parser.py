...
class SchemaParser:
    ...
    def parse(self, schema_text: str) -> SchemaDocument:
        ...
        try:
            ...
            if isinstance(e, SchemaParseError):
                raise
            raise SchemaParseError(f"Schema parsing failed: {str(e)}", self.line, self.col)
    ...
    def _consume(self, expected_type: Optional[str] = None, expected_value: Optional[str] = None) -> Dict[str, Any]:
        """
